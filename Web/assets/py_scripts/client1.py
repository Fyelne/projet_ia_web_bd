...
Exemple :
    python client1.py --haut_tot 12.0 --nb_clusters 3
"""
...
def main():
    ...
    # Charger modèle
    kmeans = joblib.load(f"../assets/models/modele_kmeans_{args.nb_clusters}.pkl")

    # Charger le mapping des clusters
    mapping = joblib.load(f"../assets/models/mapping_clusters_{args.nb_clusters}.pkl")
