...
# =========================
# 7. VERSION EXPORT CLIENT (AMÉLIORÉE)
# =========================

import plotly.express as px

# Nom des clusters (lecture plus humaine)
labels = {
    0: "Petit arbre",
    1: "Arbre moyen",
    2: "Grand arbre"
...
data["categorie"] = data["cluster"].map(labels)
...
fig2 = px.scatter_mapbox(
    ...
    title="Carte finale - Classification des arbres"
)
...
# Export en fichier HTML (livrable client)
fig2.write_html("carte_arbres.html")
